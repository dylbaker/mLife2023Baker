...
final_tree <- gheatmap(r, abund_matrix, offset =0.3, width = 2.5, color = "gray70",
...
fig_1B <- nmds_bray + plot_annotation(tag_prefix = '[', tag_suffix = ']',tag_levels = "A") &
  theme(plot.tag = element_text(size = 9.5, family = 'arial'))
#showtext_opts(dpi = 600)
ggsave('./figures/figure_pieces/figure1.png',combo_plot,width = 160, height = 152, units = "mm", dpi = 600)
ggsave('./figures/figure_pieces/figure1.svg',device = svglite::svglite, combo_plot,width = 180, height = 152, units = "mm", dpi = 600)
ggsave('./figures/figure_pieces/figure1A.png',fig_1A,width = 160, height = 100, units = "mm", dpi = 600)
ggsave('./figures/figure_pieces/figure1A.svg',device = svglite::svglite,final_tree,width = 160, height = 100, units = "mm", dpi = 600)
ggsave('./figures/figure_pieces/figure1B.png',fig_1B,width = 160, height = 80, units = "mm", dpi = 600)
ggsave('./figures/figure_pieces/figure1B.svg',device = svglite::svglite,fig_1B,width = 160, height = 100, units = "mm", dpi = 600)
